...
<!--Utilize a server/database to create persistence and maintain functionality of the blog website. Making sure we're able to create,insert,delete, and display articles.--!>


## Getting Started
<!-- Createuser (if necessary) then create role in postgres to connect to the required database. Create a const in server.js to connect to the database. Navigate the database via server.js and functions in article.js set to creat, read(retrieve), update, and delete  items from the page using information provided by the server/database-->

## Architecture
<!--Postgres and Node.js were utilized -->
